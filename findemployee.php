...
<body>
	...
	<?php
		...
		$sql = "SELECT emp_no,first_name,last_name, gender, hire_date FROM employees where emp_no = '".$empID."'";
		...
		if ($result->num_rows > 0)
		{
			...
			while($row = $result->fetch_assoc())
			{
				...
				echo "Employee: " . $row["emp_no"]. " " . $row["first_name"]. " " . $row["last_name"]. "<br>";
			}
		} 
		else 
		{
